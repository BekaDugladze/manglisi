...
export default class Select extends Component {
    ...
    handleKarkasi(){
        this.setState({karkasi: 'White'});
    }
    handleKarkasiOne(){
        this.setState({karkasi: 'Black'});
    }
                        ...
                        {this.state.bina === 'but1' && (
                            <div className="binebi">
                                ...
                                (<div className="binaDiv" key={index}>
                                    ...
                                    <div className="info">
                                        <button className="shavi" onClick={() => this.handleKarkasiOne()}>Black Frame</button>
                                        <button className="tetri" onClick={() => this.handleKarkasi()}>White Frame</button>
                                        <h2>{this.state.karkasi} Frame</h2>
                                        <p>Floor: {item.sartuli}</p>
                                        <p>M2: {item.kvadrati}</p>
                                        <p>Price for M2: 
                                            {this.state.karkasi === 'Black' ? <p>{this.state.shavi}</p> : <p>{this.state.tetri}</p>}
                                        $</p>
                                        <p>Price: {this.state.karkasi === 'Black' ? <p>{item.fasi}</p> : <p>{item.fasiTetri}</p>}$</p>
                                        {item.mdgomareoba === '' ? <a href="#kontakti">Buy Now</a> : <p className={item.mdgomareoba}>sold</p>}
                                    </div>
                                </div>))}
                            </div>
                        )}
